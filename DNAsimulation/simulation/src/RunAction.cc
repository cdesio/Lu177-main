...
void RunAction::CreateNtuple()
{
  ...
  {
    analysisManager->CreateNtupleIColumn("PrimaryEventNum");
    analysisManager->CreateNtupleIColumn("PrimaryCopyNum");
  ...
  {
  analysisManager->CreateNtupleIColumn(1, "PrimaryCopyNum");
  analysisManager->CreateNtupleIColumn(1, "PrimaryEventNum");
  ...
  analysisManager->CreateNtupleSColumn(2, "radical");
    if ((command = parser->GetCommandIfActive("-PS")))
  {
  analysisManager->CreateNtupleIColumn(2, "PrimaryCopyNum");
  analysisManager->CreateNtupleIColumn(2, "PrimaryEventNum");
